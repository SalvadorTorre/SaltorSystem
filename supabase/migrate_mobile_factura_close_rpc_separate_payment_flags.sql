...
-- Separa el pago de factura del pago de salida para permitir que choferes:
-- - marque factura.fa_fpago = 'S'
-- - conserve detsalida.pagado sin cambios
-- Mantiene el RPC anterior como wrapper compatible para otros modulos.
...
grant execute on function myappdb.mobile_cerrar_factura_app(text, boolean, boolean)
to authenticated;

grant execute on function public.mobile_cerrar_factura_app(text, boolean, boolean)
to authenticated;
