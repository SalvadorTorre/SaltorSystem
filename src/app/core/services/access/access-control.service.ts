...
export class AccessControlService {
    ...
    const templates: DefaultPermissionTemplate[] = [
      ...
      },
      {
        ...
        allowedPaths: [
          ...
          '/private/contabilidad/gastos-menores',
        ...
        actionMap: {
          ...
          '/private/contabilidad/gastos-menores': ['ver', 'acceso', 'lectura', 'crear', 'editar', 'imprimir', 'enviar_dgii'],
  ...
  private resolveRouteForPermiso(permiso: PermisoMatrizFila): string | null {
    ...
    const legacyMap: Array<[string, string]> = [
      ...
      ['nota de credito', '/private/contabilidad/nota-credito'],
      ['nota credito', '/private/contabilidad/nota-credito'],
      ['gastos menores', '/private/contabilidad/gastos-menores'],
      ['gasto menor', '/private/contabilidad/gastos-menores'],
      ...
      ['ventas por vendedor', '/private/reporte/ventas-vendedor'],
      ['rendimientos choferes', '/private/reporte/rendimiento-choferes'],
      ['rendimiento choferes', '/private/reporte/rendimiento-choferes'],
      ['rendimiento de choferes', '/private/reporte/rendimiento-choferes'],
      ['reportes', '/private/reporte'],
      ['inventario sucursal', '/private/mantenimientos/inventario-sucursal'],
      ['precio', '/private/mantenimientos/precio'],
      ['precios', '/private/mantenimientos/precio'],
      ['cambio de precio', '/private/mantenimientos/precio'],
      ['cambio de precios', '/private/mantenimientos/precio'],
      ...
      ['encf', '/private/contabilidad/encf'],
      ...
      ['envio dgii auto', '/private/mantenimientos/cola-dgii'],
      ['envio automatico dgii', '/private/mantenimientos/cola-dgii'],
      ['cola dgii', '/private/mantenimientos/cola-dgii'],
      ['facturas dgii automatico', '/private/mantenimientos/cola-dgii'],
